...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/low_pin_count_usb_development_kit_pic18f14k50.x.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-LPCUSBDK_18F14K50.mk dist/${CND_CONF}/${IMAGE_TYPE}/low_pin_count_usb_development_kit_pic18f14k50.x.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=18F14K50
# ------------------------------------------------------------------------------------
# Rules for buildStep: compile
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/_ext/910903327/buttons.p1: ../../../../../../bsp/low_pin_count_usb_development_kit/pic18f14k50/buttons.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/910903327" 
	@${RM} ${OBJECTDIR}/_ext/910903327/buttons.p1.d 
	@${RM} ${OBJECTDIR}/_ext/910903327/buttons.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=+asm,-asmfile,+speed,-space,-debug,-local --addrqual=ignore --mode=pro -P -N100 -I"../demo_src" -I"../../../../../../framework/usb/inc" -I"../../../../../../bsp/low_pin_count_usb_development_kit/pic18f14k50" -I"." --warn=0 --asmlist -DXPRJ_LPCUSBDK_18F14K50=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/_ext/910903327/buttons.p1  ../../../../../../bsp/low_pin_count_usb_development_kit/pic18f14k50/buttons.c 
	@-${MV} ${OBJECTDIR}/_ext/910903327/buttons.d ${OBJECTDIR}/_ext/910903327/buttons.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/910903327/buttons.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
	
${OBJECTDIR}/_ext/910903327/leds.p1: ../../../../../../bsp/low_pin_count_usb_development_kit/pic18f14k50/leds.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/910903327" 
	@${RM} ${OBJECTDIR}/_ext/910903327/leds.p1.d 
	@${RM} ${OBJECTDIR}/_ext/910903327/leds.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=+asm,-asmfile,+speed,-space,-debug,-local --addrqual=ignore --mode=pro -P -N100 -I"../demo_src" -I"../../../../../../framework/usb/inc" -I"../../../../../../bsp/low_pin_count_usb_development_kit/pic18f14k50" -I"." --warn=0 --asmlist -DXPRJ_LPCUSBDK_18F14K50=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/_ext/910903327/leds.p1  ../../../../../../bsp/low_pin_count_usb_development_kit/pic18f14k50/leds.c 
	@-${MV} ${OBJECTDIR}/_ext/910903327/leds.d ${OBJECTDIR}/_ext/910903327/leds.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/910903327/leds.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/low_pin_count_usb_development_kit_pic18f14k50.x.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/low_pin_count_usb_development_kit_pic18f14k50.x.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=+asm,-asmfile,+speed,-space,-debug,-local --addrqual=ignore --mode=pro -P -N100 -I"../demo_src" -I"../../../../../../framework/usb/inc" -I"../../../../../../bsp/low_pin_count_usb_development_kit/pic18f14k50" -I"." --warn=0 --asmlist -DXPRJ_LPCUSBDK_18F14K50=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     --rom=default,-3e00-3fff   $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/low_pin_count_usb_development_kit_pic18f14k50.x.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/low_pin_count_usb_development_kit_pic18f14k50.x.${IMAGE_TYPE}.hex 
